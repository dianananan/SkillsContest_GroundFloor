...
static u8 QRCode[SENDNUM] = {0xFF,0xAA,0x02,0x00,0x00,0x00,0x02,0xF0};//二维码到达点发送指令
static u8 PlateRead[SENDNUM] = {0xFF,0xAA,0x03,0x00,0x00,0x00,0x03,0xF0};//车牌到达点发送指令
static u8 ShapeRead[SENDNUM] = {0xFF,0xAA,0x04,0x00,0x00,0x00,0x04,0xF0};//图形识别到达点发送指令
static u8 TrafficRead[SENDNUM]= {0xFF,0xAA,0x05,0x00,0x00,0x00,0x05,0xF0};//交通灯到达点发送指令
static u8 TrafficLight[SENDNUM]={0xFF,0xAA,0x07,0x00,0x00,0x00,0x07,0xF0};//智能红绿灯到达发送指令
static u8 GetPoint[SENDNUM] = {0xFF,0xAA,0x06,0x00,0x00,0x00,0x06,0xF0};//发送得到入库点指令
