...
static u8 QRCode[SENDNUM] = {0xFF,0xA0,0x02,0x00,0x00,0x00,0xA2,0xF0};//二维码到达点发送指令
static u8 PlateRead[SENDNUM] = {0xFF,0xA0,0x03,0x00,0x00,0x00,0xA3,0xF0};//车牌到达点发送指令
static u8 ShapeRead[SENDNUM] = {0xFF,0xA0,0x04,0x00,0x00,0x00,0xA4,0xF0};//图形识别到达点发送指令
static u8 TrafficLight[SENDNUM]={0xFF,0xA0,0x05,0x00,0x00,0x00,0xA5,0xF0};//智能红绿灯到达发送指令
static u8 GetPoint[SENDNUM] = {0xFF,0xA0,0x06,0x00,0x00,0x00,0xA6,0xF0};//发送得到入库点指令
static u8 Pictures_Chose[SENDNUM] = {0xFF,0xA0,0x07,0x00,0x00,0x00,0xA7,0xF0};	//图片选择
